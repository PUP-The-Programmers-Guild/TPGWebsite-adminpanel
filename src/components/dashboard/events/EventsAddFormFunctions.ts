...
export const onEventAddFormSubmit = (e: React.FormEvent<HTMLFormElement>, routeSuccessCallback: () => void, imageUrl: string, imageType: string, selectedEventTypes: string[]) => {
    e.preventDefault();
